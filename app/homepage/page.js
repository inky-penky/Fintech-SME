  ...
  return (
    <div className="w-auto max-w-[40rem] flex flex-col gap-3">
      ...
      <div className="flex flex-wrap justify-center gap-4 p-2 basis-1">
        {Array(4)
          ...
          .map((e, index) => (
            <div
              key={index}
              className="flex flex-col gap-2 p-2 shadow-md bg-[#F9F9F9] rounded-xl w-[7rem]"
            >
      ...
      <div className="flex items-center justify-between p-3 my-5 text-xs font-semibold text-center">
        <span className="cursor-pointer text-[#3FC2A3] py-3 shadow-md rounded px-4">
          New Invoice
        </span>
        <span className="cursor-pointer text-[#3FC2A3] py-3 shadow-md rounded px-4 bg-[#F1FEF2]">
          <Link href={"addclient"}>Add Client</Link>
        </span>
        <span className="py-3 px-4 rounded shadow-md cursor-pointer bg-[#F9F9F9]">
          Draft
        </span>
      </div>
      ...
      <div className="flex flex-col items-center justify-center">
        <div className="flex flex-col gap-2 text-center">
          ...
          <p className="text-xs">
            Any transaction made would be saved here automatically
          </p>
        </div>
      </div>
